...
class _MyHomePageState extends State<HomePage> with LoggerMixin {
  ...
  Future<List<HomeListItem>> _initThread() async {
    ...
    final res = await api.getUserSecondRecomThread(industryId: sId);
    if (res != null && res.recomThreadList.isNotEmpty) {
