...
import 'fav_board_and_forum_entity.dart';
...
class MapConfigGroupList {
  ...
  factory MapConfigGroupList.fromJson(Map<String, dynamic> json) =>
      $MapConfigGroupListFromJson(json);
...
class MapConfigGroupListItemList {
  ...
  factory MapConfigGroupListItemList.fromJson(Map<String, dynamic> json) =>
      $MapConfigGroupListItemListFromJson(json);
