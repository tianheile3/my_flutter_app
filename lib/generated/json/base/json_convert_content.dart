...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<UserMedals>[] is M) {
      return data
              .map<UserMedals>(
                (Map<String, dynamic> e) => UserMedals.fromJson(e),
              )
              .toList()
          as M;
    }
    ...
    if (<DialogEntity>[] is M) {
      return data
              .map<DialogEntity>(
                (Map<String, dynamic> e) => DialogEntity.fromJson(e),
              )
              .toList()
          as M;
    }
    if (<DialogContentList>[] is M) {
      return data
              .map<DialogContentList>(
                (Map<String, dynamic> e) => DialogContentList.fromJson(e),
              )
              .toList()
          as M;
    }
    if (<DialogContentListUrls>[] is M) {
      return data
              .map<DialogContentListUrls>(
                (Map<String, dynamic> e) => DialogContentListUrls.fromJson(e),
              )
              .toList()
          as M;
    }
    ...
    if (<MsgList>[] is M) {
      return data
              .map<MsgList>((Map<String, dynamic> e) => MsgList.fromJson(e))
              .toList()
          as M;
    }
    if (<DialogInfo>[] is M) {
      return data
              .map<DialogInfo>(
                (Map<String, dynamic> e) => DialogInfo.fromJson(e),
              )
              .toList()
          as M;
    }
    if (<LastContent>[] is M) {
      return data
              .map<LastContent>(
                (Map<String, dynamic> e) => LastContent.fromJson(e),
              )
              .toList()
          as M;
    }
    if (<ContentObj>[] is M) {
      return data
              .map<ContentObj>(
                (Map<String, dynamic> e) => ContentObj.fromJson(e),
              )
              .toList()
          as M;
    }
    if (<ContentObjExt>[] is M) {
      return data
              .map<ContentObjExt>(
                (Map<String, dynamic> e) => ContentObjExt.fromJson(e),
              )
              .toList()
          as M;
    }
    ...
    if (<MsgGroupEntity>[] is M) {
      return data
              .map<MsgGroupEntity>(
                (Map<String, dynamic> e) => MsgGroupEntity.fromJson(e),
              )
              .toList()
          as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    ...
    (DialogEntity).toString(): DialogEntity.fromJson,
    (DialogContentList).toString(): DialogContentList.fromJson,
    (DialogContentListUrls).toString(): DialogContentListUrls.fromJson,
    ...
    (MsgList).toString(): MsgList.fromJson,
    (DialogInfo).toString(): DialogInfo.fromJson,
    (LastContent).toString(): LastContent.fromJson,
    (ContentObj).toString(): ContentObj.fromJson,
    (ContentObjExt).toString(): ContentObjExt.fromJson,
